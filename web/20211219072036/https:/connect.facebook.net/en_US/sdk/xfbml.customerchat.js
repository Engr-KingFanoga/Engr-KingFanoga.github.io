...
}
{
    ...
    /*1639898743,,JIT Construction: v1004889841,en_US*/
 ...
 */
                    ...
                    __d("JSSDKConfig", [], {
                        "features": {
                            ...
                            "https_only_learn_more": "https:\/\/web.archive.org\/web\/20211219073202\/https:\/\/developers.facebook.com\/blog\/post\/2018\/06\/08\/enforce-https-facebook-login\/",
                    ...
                    __d("JSSDKRuntimeConfig", [], {
                        ...
                        "sdkab": null,
                        "sdkns": "FB",
                        "sdkurl": "https:\/\/web.archive.org\/web\/20211219073202\/https:\/\/connect.facebook.net\/en_US\/sdk\/xfbml.customerchat.js"
                    });
                    __d("JSSDKXDConfig", [], {
                    ...
                    __d("fb-error", ["performanceNow", "removeFromArray"], (function(a, b, c, d, e, f) {
                        ...
                        var v = typeof window === "undefined" ? "<self.onerror>" : "<window.onerror>", w;
                        function aa(a) {
                        ...
                        function va(a) {
                            ...
                            if (b != null && typeof b === "object" && (b.name == null || b.name === "" || b.message == null || b.message === ""))
                                try {
                                    c = i("UnhandledRejection: %s", ES("JSON", "stringify", !1, b)),
                                    c.loggingSource = "ONUNHANDLEDREJECTION"
                                } catch (a) {
                                    c = i("UnhandledRejection: (circular) %s", Object.keys(b).join(",")),
                                    c.loggingSource = "ONUNHANDLEDREJECTION"
                                }
                            else
                                c = u(b),
                    ...
                    __d("invariant", ["Env", "fb-error-lite", "sprintf"], (function(a, b, c, d, e, f, g) {
                        ...
                        function i(a, b) {
                            a = "https://web.archive.org/web/20211219073202/https://www.internalfb.com/intern/invariant/" + a + "/";
                    ...
                    __d("FB", ["DOMWrapper", "GlobalCallback", "JSSDKCssConfig", "Log", "dotAccess", "sdk.Content", "sdk.DOM", "sdk.ErrorHandling", "sdk.domReady"], (function(a, b, c, d, e, f) {
                        ...
                        function i(a, c, d, e) {
                            return b("sdk.ErrorHandling").guard(function() {
                                ...
                                var g = Array.prototype.slice.call(arguments).map(f), h = a.apply(e, g), j, k = !0;
                    ...
                    __d("ApiBatcher", ["invariant", "ApiClientUtils", "QueryString", "sdk.safelyParseResponse", "whitelistObjectKeys"], (function(a, b, c, d, e, f, g, h) {
                        ...
                        a = function() {
                            ...
                            b.scheduleBatchCall = function() {
                                ...
                                this.$1.push(l);
                                this.$2.push(h);
                                this.$1.length == i ? (this.$4 && clearTimeout(this.$4),
                    ...
                    __d("sdk.Cookie", ["QueryString", "sdk.Runtime"], (function(a, b, c, d, e, f, g) {
                        ...
                        function i(a, b, d, e) {
                            ...
                            var f = h !== null && h !== ".";
                            f && (document.cookie = a + "=; expires=Wed, 04 Feb 2004 08:00:00 GMT" + e,
                            document.cookie = a + "=; expires=Wed, 04 Feb 2004 08:00:00 GMT;domain=" + location.hostname + e);
                    ...
                    __d("CORSRequest", ["Log", "QueryString", "RequestConstants", "sdk.Cookie", "sdk.safelyParseResponse", "wrapFunction"], (function(a, b, c, d, e, f, g) {
                        ...
                        function a(a, b, e, f) {
                            ...
                            b != "post" && (a = c("QueryString").appendToUrl(a, g),
                            g = "");
                            e = h(b, a);
                            if (!e)
                                return !1;
                    ...
                    __d("ApiClient", ["ApiBatcher", "ApiClientUtils", "Assert", "CORSRequest", "Log", "ObservableMixin", "QueryString", "UrlMap", "flattenObject"], (function(a, b, c, d, e, f, g) {
                        var h, i, j, k = [], l = 2e3, m = {
                            ...
                            stream_get: !0,
                            users_getinfo: !0
                        }, n = ["cors"], o = 0, p = [], q = 0, r = 0, s, t = d("Log");
                        function u(a, b, d, e) {
                            var f = q !== 0 && o >= q;
                            if (f) {
                                p.push(function() {
                            ...
                            l = Object.keys(i);
                            l.length > 0 && (a = c("QueryString").appendToUrl(a, i),
                            delete g.access_token);
                            l = n;
                            for (var m = 0; m < l.length; m++) {
                                var r = f[l[m]]
                                  , s = babelHelpers["extends"]({}, g);
                                if (r.execute(a, b, s, e))
                                    return
                            }
                            e({
                                error: {
                        ...
                        var x = ES("Object", "assign", !1, new (c("ObservableMixin"))(), {
                            setAccessToken: function(a) {
                                h && a && h !== a && t.error("You are overriding current access token, that means some other app is expecting different access token and you will probably break things. Please consider passing access_token directly to API parameters instead of overriding the global settings."),
                                h = a
                            },
                            ...
                            setClientID: function(a) {
                                i && i !== a && t.warn("Warning: Two different applications have attempted to set the client ID. Overriding the previously set client ID."),
                                i = a
                            },
                    ...
                    __d("FBPixelEndpoint", ["invariant", "FBEventsParamList", "FBEventsUtils"], (function(a, b, c, d, e, f, g, h) {
                        "use strict";
                        var i = "https://web.archive.org/web/20211219073202/https://www.facebook.com/tr/"
                          , j = location.href
                          , k = window.top !== window
                          , l = document.referrer;
                        function m(a, b, d, e) {
                    ...
                    __d("sdk.AppEvents", ["AppUserPropertyAPIBuiltinField", "Assert", "FBAppEvents", "sdk.Event", "sdk.Impressions", "sdk.Model", "sdk.Runtime"], (function(a, b, c, d, e, f, g) {
                        ...
                        d("sdk.Event").subscribe("init:post", function(a) {
                            ...
                            c("sdk.Runtime").getAutoLogAppEvents() && y(c("sdk.Runtime").getClientID()))
                        });
                        g.EventNames = h;
                        g.ParameterNames = j;
                        g.logEvent = w;
                    ...
                    __d("sdk.Auth", ["Log", "QueryString", "UrlMap", "sdk.AuthState", "sdk.AuthStorageUtils", "sdk.AuthUtils", "sdk.Cookie", "sdk.Frictionless", "sdk.LoggingUtils", "sdk.Runtime", "sdk.Scribe", "sdk.SignedRequest", "sdk.UA", "sdk.URI", "sdk.feature", "sdk.statusCORS"], (function(a, b, c, d, e, f, g) {
                        ...
                        function k(a) {
                            (a == null ? void 0 : a.shouldSetAuthResponse) !== !1 && ((a == null ? void 0 : a.status) === "connected" && w(),
                            l(a == null ? void 0 : a.authResponse, j(a == null ? void 0 : a.status), a == null ? void 0 : a.loginSource));
                                ...
                                if (f !== "") {
                                    ...
                                    if (window == top && b != null) {
                                        ...
                                        a = function(a) {
                                            ...
                                            h != null && a.authResponse != null && (a.authResponse.signedRequest = h));
                                            j != null && j(a)
                                        }
                                    }
                                }
                        ...
                        var n = c("Type").extend({
                          ...
                          , o = {
                            ...
                            _createMobileLoader: function() {
                                var a = document.createElement("div");
                                c("sdk.UA").nativeApp() ? a.innerHTML = '<div class="dialog_header"></div>' : o.isTabletStyle() ? a.innerHTML = '<div class="overlayLoader"><div id="fb_dialog_loader_spinner"></div><a id="fb_dialog_loader_close" href="#">' + c("sdk.fbt")._(/*FBT_CALL*/
                                "Cancel"/*FBT_CALL*/
                                ) + "</a></div>" : a.innerHTML = '<div class="dialog_header"><table>  <tbody>    <tr>      <td class="header_left">        <label class="touchable_button">          <input type="submit" value="' + c("sdk.fbt")._(/*FBT_CALL*/
                                "Cancel"/*FBT_CALL*/
                                ) + '"            id="fb_dialog_loader_close"/>        </label>      </td>      <td class="header_center">        <div>         ' + c("sdk.fbt")._(/*FBT_CALL*/
                                "Loading..."/*FBT_CALL*/
                            ...
                            _makeActive: function(a) {
                                ...
                                o._lowerActive(),
                                o._active = a,
                                c("sdk.Runtime").isEnvironment(c("sdk.Runtime").ENVIRONMENTS.CANVAS) && d("sdk.Canvas.Environment").getPageInfo(function(a) {
                                    o._centerActive(a)
                                }),
                                o._centerActive()
                            },
                    ...
                    __d("sdk.Frictionless", ["sdk.Auth", "sdk.Dialog", "sdk.Event", "sdk.api"], (function(a, b, c, d, e, f, g) {
                        var h = {
                            _allowedRecipients: {},
                            _useFrictionless: !1,
                    ...
                    __d("sdk.XD", ["JSSDKXDConfig", "Log", "QueryString", "Queue", "UrlMap", "guid", "isFacebookURI", "isInstagramURI", "resolveWindow", "sdk.Event", "sdk.RPC", "sdk.Runtime", "sdk.Scribe", "sdk.URI", "sdk.feature"], (function(a, b, c, d, e, f, g) {
                        ...
                        function s(a, b) {
                            if (b != null && b !== "native" && !c("isFacebookURI")(new (c("sdk.URI"))(b)) && !c("isInstagramURI")(new (c("sdk.URI"))(b)))
                                return;
                            if (typeof a === "string") {
                                if (/^FB_RPC:/.test(a)) {
                    ...
                    __d("sdk.openMessenger", ["sdk.UA"], (function(a, b, c, d, e, f, g) {
                        "use strict";
                        var h = "https://web.archive.org/web/20211219073202/https://itunes.apple.com/us/app/messenger/id454638411"
                          , i = "https://web.archive.org/web/20211219073202/https://play.google.com/store/apps/details?id=com.facebook.orca"
                          , j = 3e3;
                        function a(a) {
                            var b, d, e = a.link;
                            a = a.app_id;
                            ...
                            iframe: function(a) {
                                ...
                                var b = function() {
                                    var b = ES("JSON", "stringify", !1, {
                                        error_code: 4201,
                                        error_message: c("sdk.fbt")._(/*FBT_CALL*/
                                ...
                                for (var b in p._loadedNodes)
                                    if (Object.prototype.hasOwnProperty.call(p._loadedNodes, b) && b in p._defaultCb) {
                                        var d = function() {
                                            ...
                                            var e = d.node;
                                            try {
                                                e.closed ? p.isOAuth(d) ? c("sdk.Auth").getLoginStatus(function(a) {
                    ...
                    __d("legacy:fb.auth", ["FB", "Log", "sdk.Auth", "sdk.Cookie", "sdk.Event", "sdk.Runtime", "sdk.Scribe", "sdk.SignedRequest", "sdk.ui", "sdk.warnInsecure"], (function(a, b, c, d, e, f) {
                        b("FB").provide("", {
                            ...
                            login: function(a, c) {
                                ...
                                c && c.perms && !c.scope && (c.scope = c.perms,
                                delete c.perms,
                                b("Log").warn("OAuth2 specification states that 'perms' should now be called 'scope'.  Please update."));
                    ...
                    __d("sdk.Canvas.Plugin", ["Log", "sdk.RPC", "sdk.Runtime", "sdk.UA", "sdk.api"], (function(a, b, c, d, e, f, g) {
                    ...
                    __d("legacy:fb.canvas", ["Assert", "FB", "sdk.Canvas.Environment", "sdk.Canvas.IframeHandling", "sdk.Canvas.Navigation", "sdk.Canvas.Plugin", "sdk.Canvas.Tti", "sdk.Event", "sdk.RPC", "sdk.Runtime"], (function(a, b, c, d, e, f) {
                        ...
                        b("sdk.Event").subscribe("init:post", function(a) {
                            b("sdk.Runtime").isEnvironment(b("sdk.Runtime").ENVIRONMENTS.CANVAS) && (b("Assert").isTrue(!a.hideFlashCallback || !a.hidePluginCallback, "cannot specify deprecated hideFlashCallback and new hidePluginCallback"),
                            b("sdk.Canvas.Plugin")._setHidePluginCallback(a.hidePluginCallback || a.hideFlashCallback))
                        })
                    }
                    ), 3);
                    ...
                    __d("sdk.MBasicInitializer", ["UrlMap", "sdk.DOM", "sdk.Runtime", "sdk.UA", "sdk.URI", "sdk.fbt"], (function(a, b, c, d, e, f, g) {
                        var h = function() {
                            function a(a) {
                                ...
                                e.textContent = c("sdk.fbt")._(/*FBT_CALL*/
                                "Share to Facebook"/*FBT_CALL*/
                                );
                    ...
                    __d("sdk.Time", ["Log", "sdk.Impressions", "sdk.Runtime", "sdk.feature"], (function(a, b, c, d, e, f, g) {
                        ...
                        if (i) {
                            ...
                            "transferSize"in e && (k.transferSize = e.transferSize,
                    ...
                    __d("sdk.createIframe", ["DOMEventListener", "getBlankIframeSrc", "guid", "isNumberLike"], (function(a, b, c, d, e, f, g) {
                        function a(a) {
                            ...
                            delete b.testid);
                            for (var l in b)
                                Object.prototype.hasOwnProperty.call(b, l) && e.setAttribute(l, b[l]);
                        ...
                        var h = c("Type").extend({
                            constructor: function(a, b, e, f) {
                                ...
                                this.subscribe("xd.refreshLoginStatus", function() {
                                    d("sdk.AuthUtils").removeLogoutState(),
                                    c("sdk.Auth").getLoginStatus(ES(g.inform, "bind", !0, g, "login.status"), !0)
                                });
                                ...
                                this.isFluid() && j.width !== "auto" && (d("sdk.DOM").addCss(this._element, "fb_iframe_widget_fluid_desktop"),
                                !j.width && this._config.full_width && (this._element.style.width = "100%",
                                this._iframeOptions.root.style.width = "100%",
                                this._iframeOptions.style.width = "100%",
                                this._params.container_width = this._element.offsetWidth,
                                this._iframeOptions.url = i + c("QueryString").encode(this._params)))
                            },
                    ...
                    __d("ChatPluginStyleUtils", [], (function(a, b, c, d, e, f) {
                        ...
                        function d(a, b, c, d, e, f) {
                            ...
                            var i = b + o - 16;
                            e ? (i = b - 16,
                            d === "none" ? f === "compact" ? i += p : i += o : f === "compact" ? i += h : i += g) : f === "compact" && (i = b + p - 16);
                            e = {
                        ...
                        function s(a, b, c, d, e, f, i, j) {
                            c = c - q;
                            var k = o;
                            f ? e === "none" ? i === "compact" ? k = p : k = o : i === "compact" ? k = h : k = g : i === "compact" && (k = p);
                            f = k + b;
                            ...
                            switch (a) {
                            case "right":
                                i += " right: 4px; margin-right: " + c + "px;";
                                break;
                            case "left":
                                i += " left: -4px; margin-left: " + c + "px;";
                                break
                            }
                            return i
                        }
                        ...
                        function u(a, b, c, d, e, f, i) {
                            ...
                            var j = o + q;
                            f ? (j = q,
                            e === "none" ? i === "compact" ? j += p : j += o : i === "compact" ? j += h : j += g) : i === "compact" && (j = p + q);
                            f = j + b;
                            e = " bottom: " + f.toString() + "px;";
                        ...
                        f.ICON_ENTRY_POINT_STANDARD_HEIGHT = o;
                        f.ICON_ENTRY_POINT_COMPACT_HEIGHT = p;
                        f.getMobileStyleText = a;
                        f.positionElementAtWindowFooter = b;
                        f.getEntryPointStyle = r;
                        f.getIconStyleText = c;
                        f.getUnreadCountStyleText = d;
                        f.getMobileLandingStyleText = e;
                        f.getDesktopStyleText = s;
                        f.getMobileFullScreenStyleText = t;
                        f.getDesktopWelcomeMessageStyleText = u;
                        f.getMobileWelcomeMessageStyleText = v
                    }
                    ), 66);
                        ...
                        a = function(a) {
                            ...
                            e.render = function(a) {
                                ...
                                c("CORSRequest").execute(a, "get", this.params, function(a) {
                                    ...
                                    e = b.$ChatDOMFacade8 === "compact" ? d("ChatPluginStyleUtils").LABELED_ENTRY_POINT_COMPACT_HEIGHT : d("ChatPluginStyleUtils").LABELED_ENTRY_POINT_STANDARD_HEIGHT;
                                    var j = b.$ChatDOMFacade8 === "compact" ? d("ChatPluginStyleUtils").LABELED_ENTRY_POINT_COMPACT_FONT_SIZE : d("ChatPluginStyleUtils").LABELED_ENTRY_POINT_STANDARD_FONT_SIZE
                                      , k = b.$ChatDOMFacade8 === "compact" ? d("ChatPluginStyleUtils").LABELED_ENTRY_POINT_COMPACT_LINE_HEIGHT : d("ChatPluginStyleUtils").LABELED_ENTRY_POINT_STANDARD_LINE_HEIGHT
                                      , l = b.$ChatDOMFacade8 === "compact" ? d("ChatPluginStyleUtils").LABELED_ENTRY_POINT_COMPACT_ICON_MARGIN_RIGHT : d("ChatPluginStyleUtils").LABELED_ENTRY_POINT_STANDARD_ICON_MARGIN_RIGHT;
                                    if (b.$ChatDOMFacade9 === "none") {
                                        var m = document.createElement("div");
                                        d("sdk.DOM").html(m, a.entry_point_icon_svg);
                                        m = (m = m.children[0]) == null ? void 0 : (m = m.children[1]) == null ? void 0 : m.outerHTML;
                                        d("sdk.DOM").html(b.$ChatDOMFacade3, m)
                                    } else {
                                        m = a.entry_point_icon_svg;
                                        d("sdk.DOM").html(b.$ChatDOMFacade3, b.$ChatDOMFacade12(e, l, j, k, m))
                                    }
                            ...
                            e.$ChatDOMFacade15 = function() {
                                ...
                                if (this.$ChatDOMFacade9 === "none") {
                                    var a = this.$ChatDOMFacade16(.6);
                                    d("sdk.DOM").html(this.$ChatDOMFacade3, a)
                                } else {
                                    a = this.$ChatDOMFacade8 === "compact" ? .8 : 1;
                                    ...
                                    if (this.$ChatDOMFacade10 === "none") {
                                        ...
                                        d("sdk.DOM").html(this.$ChatDOMFacade3.children[0].children[0], a)
                                }
                                this.$ChatDOMFacade2 = !0
                            }
                            ;
                            e.$ChatDOMFacade12 = function(a, b, c, d, e) {
                            ...
                            e.$ChatDOMFacade16 = function(a) {
                                return '\n      <svg class="spinning" x="0" y="0" viewbox="0 0 60 60">\n        <circle transform="scale(' + a + ')" class="path" cx="30" cy="30" r="24" fill="none" stroke-width="6"></circle>\n      </svg>\n    '
                            }
                            ;
                            ...
                            e.$ChatDOMFacade11 = function(a, b) {
                                ...
                                if (this.$ChatDOMFacade1 !== h.WAITING)
                                    return;
                    ...
                    __d("getFacebookOriginForTarget", ["Log"], (function(a, b, c, d, e, f, g) {
                        function a(a, b) {
                            ...
                            window.addEventListener("message", function(c) {
                                c.source === b && c.data.xdArbiterAck && (/\.facebook\.com$/.test(c.origin) && /^https:/.test(c.origin) ? e === !1 && (e = !0,
                    ...
                    __d("sdk.XFBML.CustomerChat", ["ChatPluginSDKPreLoggingUtils", "DOMEventListener", "IframePlugin", "Log", "MPNExplicitUserInteractions", "MPNLocalState", "QueryString", "UrlMap", "getFacebookOriginForTarget", "performanceAbsoluteNow", "sdk.Content", "sdk.DOM", "sdk.DialogUtils", "sdk.DocumentTitle", "sdk.Event", "sdk.Runtime", "sdk.UA", "sdk.URI", "sdk.WebStorage", "sdk.XD", "sdk.XFBML.CustomerChatWrapper", "sdk.cp.Actions", "sdk.createIframe", "uuid"], (function(a, b, c, d, e, f, g) {
                        ...
                        var h = ["animationend", "mozAnimationEnd", "MSAnimationEnd", "oAnimationEnd", "webkitAnimationEnd"]
                          ...
                          , B = c("IframePlugin").extend({
                            constructor: function(a, b, c, e) {
                                ...
                                d("ChatPluginSDKPreLoggingUtils").preLogging("chat_plugin_sdk_dialog_iframe_create", this._params, !1)
                            },
                            ...
                            _handleSetupDialogIframe: function(a) {
                                ...
                                t = null;
                                p = f === "true";
                                this._iframe && (this._iframe.setAttribute("data-testid", "dialog_iframe"),
                            ...
                            _handleReload: function(a) {
                                var b, e = new (c("sdk.URI"))(this._iframe.src), f = e.getQueryData();
                            ...
                            _storeStateInfo: function(a) {
                                ...
                                try {
                                    if (a == null)
                                        ...
                                        if (c == null)
                                            b.setItem(d("MPNLocalState").LOCAL_STATE_KEY, ES("JSON", "stringify", !1, ES("JSON", "parse", !1, a)));
                                        else {
                                            c = ES("JSON", "parse", !1, c);
                                            a = ES("JSON", "parse", !1, a);
                            ...
                            _handleUpdatePageTitle: function(a) {
                                var b = this;
                                !i && a.titleText ? (i = d("sdk.DocumentTitle").blink(a.titleText),
                        ...
                        function I(a) {
                            ...
                            if (t === null || t === !0) {
                                ...
                                h.forEach(function(b) {
                                    var c = function(b) {
                                        p && (d("sdk.DOM").setStyle(a, "maxHeight", "0"),
                                        d("sdk.DOM").setStyle(a, "minHeight", "0"),
                                        h.forEach(function(b) {
                                            e[b] && (d("DOMEventListener").remove(a, b, e[b]),
                                            delete e[b])
                                        }),
                                        t = !1)
                                    };
                        ...
                        function J() {
                            if (!j)
                                return;
                            var a = d("sdk.DOM").getAttr(j, u), b = d("sdk.DOM").getAttr(j, v), e = c("sdk.UA").mobile(), f;
                            if (e)
                                switch (b) {
                                case z:
                        ...
                        a = function(a) {
                            ...
                            function b(b, e, f, g) {
                                ...
                                h.subscribe("xd.resize.flow", function(a) {
                                    ...
                                    d("sdk.PluginUtils").resize(h.iframeOptions.root, d("sdk.PluginUtils").parse(a.width), d("sdk.PluginUtils").parse(a.height)),
                                    h.updateLift(),
                                ...
                                h.subscribe("xd.resize", function(a) {
                                    ...
                                    d("sdk.PluginUtils").resize(h.iframeOptions.root, d("sdk.PluginUtils").parse(a.width), d("sdk.PluginUtils").parse(a.height)),
                                    d("sdk.PluginUtils").resize(h.iframe, d("sdk.PluginUtils").parse(a.width), d("sdk.PluginUtils").parse(a.height)),
                                ...
                                h.subscribe("xd.refreshLoginStatus", function() {
                                    d("sdk.AuthUtils").removeLogoutState(),
                                    c("sdk.Auth").getLoginStatus(ES(h.inform, "bind", !0, babelHelpers.assertThisInitialized(h), "login.status"), !0)
                                });
                                ...
                                h.config.fluid && k.width !== "auto" && (d("sdk.DOM").addCss(h.element, "fbiframe_widget_fluid_desktop"),
                                !k.width && h.config.full_width && (h.element.style.width = "100%",
                                h.iframeOptions.root.style.width = "100%",
                                h.iframeOptions.style.width = "100%",
                                h.params.container_width = h.element.offsetWidth,
                                h.iframeOptions.url = j + c("QueryString").encode(h.params)));
                                return h
                            }
                            var e = b.prototype;
                            ...
                            e.process = function() {
                                ...
                                this.subscribe("render", function() {
                                    ...
                                    a.$IframePluginClass2 || d("sdk.PluginUtils").collapseIframe(a.iframe)
                                });
                        ...
                        a = function(a) {
                            ...
                            function b(b, c, e, f) {
                                ...
                                g.show = function(a) {
                                    a === void 0 && (a = !0),
                                    g.$CustomerChat11 = !1,
                                    g.$CustomerChat1 != null && d("sdk.DOM").setStyle(g.$CustomerChat1, "display", "inline"),
                                ...
                                g.hide = function() {
                                    g.$CustomerChat11 = !0,
                                    g.$CustomerChat1 != null && d("sdk.DOM").setStyle(g.$CustomerChat1, "display", "none"),
                            ...
                            e.$CustomerChat20 = function() {
                                this.$CustomerChat2 !== null && this.$CustomerChat7 !== null && this.$CustomerChat5 !== null && !this.$CustomerChat8 && (this.$CustomerChat8 = !0,
                            ...
                            e.$CustomerChat17 = function(a) {
                                var b = a.cssText
                                  ...
                                  , f = a.isDialogHidden;
                                a = a.desktopBottomSpacing;
                                this.$CustomerChat1 && (e && this.$CustomerChat1.setAttribute(c("sdk.cp.Constants").attribute.mobilePath, e),
                                a && this.$CustomerChat1.setAttribute(c("sdk.cp.Constants").attribute.desktopBottomSpacing, a.toString()));
                            ...
                            e.$CustomerChat22 = function(a) {
                                ...
                                if (!this.$CustomerChat10) {
                                    ...
                                    c("sdk.cp.Constants").animationEvents.forEach(function(e) {
                                        var f = function(e) {
                                            b.$CustomerChat10 && (d("sdk.DOM").setStyle(a, "maxHeight", "0"),
                                            d("sdk.DOM").setStyle(a, "minHeight", "0"),
        ...
        i.src = 'https://web.archive.org/web/20211219073202/https://www.facebook.com/platform/scribe_endpoint.php/?c=jssdk_error&m=' + encodeURIComponent('{"error":"LOAD", "extra": {"name":"' + e.name + '","line":"' + (e.lineNumber || e.line) + '","script":"' + (e.fileName || e.sourceURL || e.script || "xfbml.customerchat.js") + '","stack":"' + (e.stackTrace || e.stack) + '","revision":"1004889841","namespace":"FB","message":"' + e.message + '"}}');
